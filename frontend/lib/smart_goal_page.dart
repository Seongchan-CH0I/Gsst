...
class _SmartGoalPageState extends State<SmartGoalPage> {
  ...
  final _includeIngredientsController = TextEditingController();
  final _availableIngredientsController = TextEditingController();
  final _preferenceKeywordsController = TextEditingController();
  final _avoidKeywordsController = TextEditingController();

  bool _isLoading = false;
  final List<List<dynamic>> _recipeHistory = [];
  int _historyIndex = -1;
      ...
      if (response.statusCode == 200) {
        ...
        if (recipes.isNotEmpty) {
          setState(() {
            ...
            _historyIndex = _recipeHistory.length - 1;
          });
  ...
  int? _parseCost(String? cost) {
    ...
    if (cost.contains('10,000원 이상')) return 15000;
    return null;
  }
